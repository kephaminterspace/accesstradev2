...
<body>
   <?php
                    ...
                    <div class="container">
                        <div class="row">
                            <div class="col-xs-12 col-sm-5">
                                <div class="slide-info text-left">
                                    <h3 class="" data-animation="animated bounceInUp">Chi phí trên hiệu suất thực tế</h3>
                ...
                <div class="item bk slide-2 white-text carousel-caption">
                    <div class="container">
                        <div class="row">
                            <div class="col-xs-12 col-sm-5">
                                <div class="slide-info text-left">
                                    <h3 class="" data-animation="animated bounceInUp">Hệ thống quảng cáo thông minh</h3>
                ...
                <div class="item bk slide-6 white-text carousel-caption">
                    <div class="container">
                        <div class="row">
                            <div class="col-xs-12 col-sm-5">
                                <div class="slide-info text-left">
                                    <h3 class="" data-animation="animated bounceInUp">Tỷ lệ lợi tức đầu tư (ROI) 100%</h3>
                ...
                <div class="item bk  slide-5 carousel-caption">
                    <div class="container">
                        <div class="row">
                            <div class="col-xs-12 col-sm-5">
                                <div class="slide-info text-left">
                                    <h3 class="" data-animation="animated bounceInUp">Quảng bá thương hiệu rộng rãi</h3>
    ...
    <section class="content-block bor-t bor-b">
        <div class="container">
            <div class="row">
                ...
                <div class="walking-block process-inner clearfix">
                    <div class="col-xs-12 col-sm-6 col-md-3 text-center">
                        <div class="process-item-holder wow fadeInUpBig" data-wow-delay="0s">
                            ...
                            <div class="content-holder">
                                ...
                                <p>Người dùng truy cập vào trang của Publisher</p>
                            </div>
                        </div>
                    ...
                    <div class="col-xs-12 col-sm-6 col-md-3 text-center">
                        <div class="process-item-holder wow fadeInUpBig"  data-wow-delay="0.2s">
                            ...
                            <div class="content-holder">
                                ...
                                <p>Người dùng thực hiện mua hàng, đăng ký, điền form trên website nhà cung cấp</p>
                            </div>
                        </div>
                        <div class="arrow wow fadeIn" data-wow-delay="0.8s">
                                <span class="ti-angle-right"></span>
                    ...
                    <div class="col-xs-12 col-sm-6 col-md-3 text-center">
                        <div class="process-item-holder wow fadeInUpBig"  data-wow-delay="0.4s">
                            ...
                            <div class="content-holder">
                                ...
                                <p>Thống kê và đối soát kết quả chiến dịch quảng cáo</p>
                            </div>
                        </div>
                        <div class="arrow wow fadeIn" data-wow-delay="0.8s">
                                <span class="ti-angle-right"></span>
                    ...
                    <div class="col-xs-12 col-sm-6 col-md-3 text-center">
                        <div class="process-item-holder wow fadeInUpBig"  data-wow-delay="0.6s">
                            ...
                            <div class="content-holder">
                                ...
                                <p>Nhà cung cấp trả tiền cho ACCESSTRADE</p>
                            </div>
                        </div>
                    </div>
                </div>
    ...
    <section class="content-block bk-black white-text">
        <div class="container">
            <div class="row">
                <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                    <div class="title-block text-center ">
                        <h3 class="section-title">Phương thức Marketing hoàn toàn khác biệt</h3>
