...
<body>
        ...
        <div class="container">
            <div class="row">
                <div class="col-xs-12 col-sm-6">
                    <span class="breadcrumb-title">Thương mại điện tử</span>
                </div>
    ...
    <section class="content-block2 tour-block study-block bk-blue white-text">
       <div class="container">
            <div class="row">
                <div class="col-xs-12 col-sm-5">
                    <div class="wpb_wrapper">
                        <div class="mkdf-section-title-holder">
                            <h3 class="section-title">THƯƠNG MẠI ĐIỆN TỬ</h3></div>
                        <div class="mkdf-section-subtitle-holder">
                            <p class="mkdf-section-subtitle" >ACCESSTRADE giúp nhà cung cấp tăng trưởng doanh thu đột phá, quảng bá thương hiệu rộng rãi.</br></br> 
Nhà cung cấp chỉ phải trả phí khi người dùng thực hiện mua hàng thành công thông qua hệ thống đối tác của ACCESSTRADE</p>
                        </div>
                        ...
                        <ul class="study-number clearfix" style="display: table;width: 100%;">
                           <li class="text-center">
                               ...
                               <span class="study-n-title" style="    color: #fdd325 !important;">35 Tỷ</span>
                           </li> 
                           
                           <li class="text-center">
                               <span class="study-k-title">cvr</span>
                               <span class="study-n-title" style="    color: #fdd325 !important;">15%-20%</span>
                           </li> 
                        </ul>
                    </div>
