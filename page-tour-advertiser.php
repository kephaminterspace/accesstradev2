            ...
            <div class="row">
                <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 text-center">
                   <div class="title-block text-center ">
                        <h3 class="section-title">03 BƯỚC TRỞ THÀNH NHÀ CUNG CẤP CỦA ACCESSTRADE</h3>
        ...
        <div class="container">
            <div class="row">
                <div class="col-xs-12 col-sm-5">
                    <div class="wpb_wrapper">
                        <div class="mkdf-section-title-holder">
                            <h3 class="section-title">QUẢNG BÁ CHÍNH THỨC</h3></div>
                        <div class="mkdf-section-subtitle-holder">
                            <p  class="mkdf-section-subtitle">
                            Thông báo chính thức tới Đối tác quảng bá chiến dịch</br>
                ...
                <div class="col-xs-12 col-sm-7">
                    <div class="images-wrap">
                    <img src="<?php echo esc_url( get_template_directory_uri() ); ?>/assets/images/tour-24.jpg" alt="">
                </div>
                </div>
