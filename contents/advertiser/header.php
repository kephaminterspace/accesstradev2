                    ...
                    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                        ...
                        <div class="navbar-top-right pull-right">
                            <ul class="clearfix">
                                ...
                                <li class="navbar-top-btn blue"><a href="<?php echo esc_url(home_url( '/' )) ;?>">Publisher</a></li>
                            </ul>
                        </div>
                    </div>
                </div>
                        ...
                        <nav class="navbar navbar-default" role="navigation">
                            ...
                            <div class="collapse navbar-collapse navbar-ex1-collapse">
                                <ul class="nav navbar-nav navbar-right">
                                    <li><a href="<?php echo esc_url(home_url( '/' )) ;?>advertiser">Trang chủ</a></li>
                                    ...
                                    <li class="navbar-nav-btn"><a href="https://member.accesstrade.vn/m/merchantlogin" target="_blank">Đăng nhập</a></li>
