...
<head>
    ...
    <title>Advertiser case study beauty</title>
...
<body>
        ...
        <div class="container">
            <div class="row">
                <div class="col-xs-12 col-sm-6">
                    <span class="breadcrumb-title">Làm đẹp</span>
                </div>
    ...
    <section class="content-block2 tour-block study-block bk-pink white-text">
       <div class="container">
            <div class="row">
                <div class="col-xs-12 col-sm-5">
                    <div class="wpb_wrapper">
                        <div class="mkdf-section-title-holder">
                            <h3 class="section-title">Làm đẹp</h3></div>
                        <div class="mkdf-section-subtitle-holder">
                            <p class="mkdf-section-subtitle" >ACCESSTRADE giúp gia tăng số lượng khách hàng tiềm năng sử dụng dịch vụ. Nhà cung cấp chỉ phải trả phí khi người dùng thực hiện đăng ký nhận tư vấn, đến trực tiếp nhận tư vấn … thành công thông qua hệ thống đối tác của ACCESSTRADE.</p>
                        </div>
                        <div class="vc_empty_space" style="height: 15px"><span class="vc_empty_space_inner"></span></div>
                        <ul class="study-number clearfix" style="display: table;width: 100%;">
                           <li class="text-center">
                               <span class="study-k-title" style="">Doanh thu/Tháng</span>
